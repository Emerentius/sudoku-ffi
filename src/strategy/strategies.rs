...
impl From<RStrategy> for Strategy {
    fn from(strat: RStrategy) -> Self {
        ...
        match strat {
            ...
            RStrategy::XyWing => XyWing,
            RStrategy::XyzWing => XyzWing,
            RStrategy::MutantSwordfish => MutantSwordfish,
            RStrategy::MutantJellyfish => MutantJellyfish,
            RStrategy::AvoidableRectangles => AvoidableRectangles,
...
impl From<Strategy> for RStrategy {
    ...
    fn from(strat: Strategy) -> RStrategy {
        ...
        match strat {
            ...
            XyWing => RStrategy::XyWing,
            XyzWing => RStrategy::XyzWing,
            MutantSwordfish => RStrategy::MutantSwordfish,
            MutantJellyfish => RStrategy::MutantJellyfish,
            AvoidableRectangles => RStrategy::AvoidableRectangles,
